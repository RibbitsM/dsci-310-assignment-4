...
![](../results/horse_pops_plot.png){#fig-horse_provinces width=90%}

Figure 1: Horse populations for all provinces in Canada from 1906 - 1972.

We can see from @fig-horse_provinces that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-horses we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_provinces.

![](../results/horse_pop_plot_largest_sd.png){#fig-horse width=70%}

Figure 2: Horse populations for the province with the largest standard deviation

In @fig-horse we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
